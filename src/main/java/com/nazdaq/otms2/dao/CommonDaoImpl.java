...
public class CommonDaoImpl implements CommonDao {
	...
	public void deleteObjectListByFourColumn(String objectName, String column1, String columnValue1, String column2, String columnValue2, String column3, String columnValue3, String column4, String columnValue4) {
		try {
			Session session = sessionFactory.getCurrentSession();
			List<Object> objectList = getObjectListByFourColumnWithoutLike(objectName, column1, columnValue1, column2, columnValue2, column3, columnValue3, column4, columnValue4);
			for (Object ob : objectList) {
				session.delete(ob);
			}
