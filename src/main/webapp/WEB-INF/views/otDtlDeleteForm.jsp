...
<body>
	<!-- Page heading start -->
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">Overtime Details Delete From</h2>
					...
					<div class="widget-content">
						<div class="padd">
							...
							<form:form cssClass="form-horizontal" method="POST"
								id="otDtlDeleteFormId" class="form-horizontal"
								modelAttribute="overtimeDtlForm"
								action="${pageContext.request.contextPath}/otDtlDelete">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('.ai-save-update-btn').click(function() {
				...
				if (!flag) {
					w2confirm('Are you sure, Delete Data for Selected Month? If Yes, you will loss data permanently and need to generate again.', function btn(answer) {
					    if(answer == 'Yes'){
					    	$(".ai-save-update-btn").prop('disabled', true);
							$('#otDtlDeleteFormId').submit();
					    } else {
					    	$(".ai-save-update-btn").prop('disabled', false);
					    }
					});
